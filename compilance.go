...
func uploadComplianceDocument(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
	...
	entityCompMap, err := fetchEntityComplianceDocumentMapping(stub, compDoc.Borrower)
	...
	if err != nil {
		...
		saveEntityComplianceDocumentMapping(stub, entityCompMapRequest, compDoc.Borrower)
	} else {
